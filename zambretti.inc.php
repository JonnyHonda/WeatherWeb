...
// usage: forecast = betel_cast( $z_month, $z_wind, $z_trend [, $z_hpa,  $z_where] [, $z_baro_top] [, $z_baro_bottom]);
...
function betel_cast($z_hpa, $z_month, $z_wind, $z_trend,  $z_where = 1, $z_baro_top = 1050, $z_baro_bottom = 950) {
    $z_forecast = Array("Settled fine", "Fine weather", "Becoming fine", 
        ...
        "Unsettled, rain later", "Unsettled, some rain", "Mostly very unsettled", 
...
// $z_hpa -= 11 ;
  ...
  //  echo " $z_option = floor(($z_hpa - $z_baro_bottom) / $z_constant)\n";
    $z_output = "";
    if ($z_option < 0) {
        $z_option = 0;
